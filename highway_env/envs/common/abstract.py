...
class AbstractEnv(gym.Env):
    ...
    def rule(self):
        """
        Check the safety of all actions according to rules.
        ...
        if len(side_lanes) == 1:
            if side_lanes[0][2] != lane_index[2] - 1 and 0 in available_actions:
                available_actions.remove(0)
            if side_lanes[0][2] != lane_index[2] + 1 and 2 in available_actions:
                available_actions.remove(2)
